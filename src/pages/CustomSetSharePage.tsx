...
import { Copy, Share2, ArrowRight, QrCode, Twitter, Globe, Lock } from "lucide-react";
import { useCustomSet, useUpdateCustomSetVisibility } from "@/hooks/customSets";
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <Label htmlFor="public-toggle" className="font-medium cursor-pointer">
                  {customSet?.is_public ? 'Public Set' : 'Private Set'}
                </Label>
                <p className="text-xs text-muted-foreground">
                  {customSet?.is_public 
                    ? 'Anyone with the code can view and practice'
