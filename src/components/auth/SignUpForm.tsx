...
export const SignUpForm = () => {
  ...
  return (
    <form onSubmit={handleSignUp} className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="signup-status">What do you do?</Label>
        <div className="relative">
          <Briefcase className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground z-10" />
          <Select value={status} onValueChange={setStatus}>
            <SelectTrigger id="signup-status" className="pl-10 h-11 bg-secondary/30">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          type="button"
          variant="outline"
          className="h-11 border-border hover:bg-secondary/80 transition-colors"
